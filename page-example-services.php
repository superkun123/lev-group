<?php
/*
Template Name: внутренние страницы услуг
Template Post Type: page, post, main_service
*/
?>
...
<main class="blog-page main_service">
...
<!--                        <div class="post-date">--><?php //the_date('j F Y'); ?><!--</div>-->
                    ...
                    <!--                                    <div class="img-col">-->
                    <!--                                        <img src="-->
                    <?php //echo get_sub_field('text-left_img'); ?><!--" alt="">-->
                    <!--                                    </div>-->
                    <!--                                </div>-->
                    <!--                                <div class="col-lg-6">-->
                    <!--                                    <div class="text-col">-->
                    <!--                                        <p> -->
                    <?php //echo get_sub_field('text-left_text'); ?><!--</p>-->
                    <!--                                    </div>-->
                    <!--                                </div>-->
                    <!--                            </div>-->
                    <!---->
...
<!--                        <div class="author-title">Автор:</div>-->
                        <article class="author-card gray-bg">
