...
<?php
$id = 56;// Обязательно передавать переменную
$post = get_post($id);
?>
<div class="container">
    ...
    <div class="container company-container">
        <div class="row">
            ...
            <?php
               ...
               <div class="dir-block">
                   <div class="img" style="background-image: url(<?php the_sub_field('page_service_left_img') ?>)"></div>
                   <div class="quote">
                       <?php the_sub_field('page_service_left_descr') ?>
                   </div>
               </div>
                    ...
                    <div class="row  space-between about-company-row">
                        <div class="col-lg-12">
                            <div class="about-company__description">
                                <h1 class="about-company-description__title">
                                    <?php
                        ...
                        if (have_posts()) {
                            ...
                            while (have_posts()) {
                                ...
                                <a href="<?php the_permalink(); ?>" class="services-card col-lg">
                                    ...
                                    <img class="services-card__img" src="<?php echo the_post_thumbnail_url(); ?>"
                                         alt="">
                                </a>
                                <?php
                            }
