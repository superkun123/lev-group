...
if (jQuery('body').hasClass('team-template-out-team-post')) {
    const firstBread = bread.find('.home')[0]
    const father = firstBread.closest( "span" )
    jQuery(`<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Перейти к ЛЕВЪ." href="https://lev-group.ru/about/" class="home" data-wpel-link="internal"><span property="name">О компании</span></a><meta property="position" content="1"></span>
    <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Перейти к ЛЕВЪ." href="https://lev-group.ru/about/nashi-sotrudniki/" class="home" data-wpel-link="internal"><span property="name">Команда</span></a><meta property="position" content="1"></span>`).insertAfter( father );
...
jQuery(document).on('ready', function () {
    ...
    function moveMember () {
        ...
        noPhotoArr.addClass('show-photo')
